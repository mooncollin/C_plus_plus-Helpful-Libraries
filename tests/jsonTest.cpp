...
class json_speed_test : public collin::test::test_case
{
	public:
		json_speed_test()
			: collin::test::test_case{"json_speed_test"} {}
...
int main()
{
	...
	suite.add_test_case<json_parse_test>();
	suite.add_test_case<json_speed_test>();
