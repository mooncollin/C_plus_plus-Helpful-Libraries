	...
	namespace windows
	{
		class graphics_scene
		{
			public:
				...
				::HRESULT resize(const graphics::size2D_u& size)
				{
					auto hr = S_OK;
					if (render_target)
					{
			...
			protected:
				cmoon::windows::unique_com_ptr<::ID2D1Factory> factory;
				cmoon::windows::unique_com_ptr<::ID2D1HwndRenderTarget> render_target;
