...
namespace cmoon
{
	...
	inline constexpr CharT newline{'\n'};
	...
	export
	std::ostream& fprint(std::ostream& os, std::string_view str)
	{
		return os.write(str.data(), std::size(str));
	}
	...
	export
	std::wostream& fprint(std::wostream& os, std::wstring_view str)
	{
		return os.write(str.data(), std::size(str));
	}
	...
	auto fprintln(std::FILE* file, char ch) noexcept
	{
		...
		return first_write + fprint(file, newline<char>);
	}
	...
	{
		const auto first_write {fprint(file, ch)};
		return first_write + fprint(file, newline<wchar_t>);
	}
	...
	export
	std::ostream& fprintln(std::ostream& os, std::string_view str)
	{
		os.write(str.data(), std::size(str));
		return fprintln(os);
	}
	...
	export
	std::wostream& fprintln(std::wostream& os, std::wstring_view str)
	{
		os.write(str.data(), std::size(str));
		return fprintln(os);
	}
