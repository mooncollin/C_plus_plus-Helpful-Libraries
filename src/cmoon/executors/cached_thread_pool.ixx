	...
	class cached_thread_pool
	{
		...
		class sender_t
		{
			...
			public:
				...
				auto query(const cmoon::execution::allocator_t<A>) const noexcept
				{
					return a_;
				}
				...
				bool running_in_this_thread() const noexcept
				{
					...
					else
					{
						...
						return pool_.get().thread_ids.contains(std::this_thread::get_id());
					}
				}
			private:
		...
		class scheduler_t
		{
			public:
				...
				auto query(const cmoon::execution::allocator_t<Allocator>) const noexcept
				{
					return a_;
				}
