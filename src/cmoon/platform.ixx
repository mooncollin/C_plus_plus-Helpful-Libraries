...
namespace cmoon
{
	...
	export
	inline constexpr compiler_e compiler =
	...
	export
	inline constexpr operating_system_e operating_system =
	#if defined(_AIX)
	...
	export
	inline constexpr bool win32_api = (operating_system == operating_system_e::win32) ||
	...
	export
	inline constexpr bool posix_api = (operating_system == operating_system_e::aix) ||
	...
	export
	inline constexpr architecture_e architecture = 
	...
	export
	inline constexpr cpp_version_e cpp_version = 
