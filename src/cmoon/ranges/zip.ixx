...
namespace cmoon::ranges
{
	...
	class zip_view : public std::ranges::view_interface<zip_view<Rngs...>>
	{
		class zip_view_iterator
		{
			...
			public:
				using iterator_category = std::conditional_t<std::conjunction_v<std::bool_constant<std::ranges::contiguous_range<Rngs>>...>,
				...
				constexpr zip_view_iterator& operator--() requires(std::same_as<iterator_category, std::bidirectional_iterator_tag> ||
				...
				constexpr zip_view_iterator operator--(int) requires(std::same_as<iterator_category, std::bidirectional_iterator_tag> ||
																     std::same_as<iterator_category, std::random_access_iterator_tag> ||
																     std::same_as<iterator_category, std::contiguous_iterator_tag>)
				{
					auto tmp = *this;
				...
				constexpr zip_view_iterator& operator+=(difference_type n) requires(std::same_as<iterator_category, std::random_access_iterator_tag> ||
																				    std::same_as<iterator_category, std::contiguous_iterator_tag>)
				{
				...
				[[nodiscard]] friend constexpr zip_view_iterator operator+(const zip_view_iterator& lhs, difference_type rhs) requires(std::same_as<iterator_category, std::random_access_iterator_tag> ||
																																	   std::same_as<iterator_category, std::contiguous_iterator_tag>)
				{
					auto tmp = lhs;
					tmp += rhs;
