...
namespace cmoon::cuda
{
	template<class T>
	__global__
	void plus_ranges_kernel(int n, const T* const input1, const T* const input2, T* out) noexcept
	{
	...
	template<class T>
	void plus_ranges_impl(int n, const T* const input1, const T* const input2, T* out) noexcept
	{
