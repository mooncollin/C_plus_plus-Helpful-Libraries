...
namespace collin
{
    namespace measures
    {
        template<collin::concepts::arithmetic Rep, collin::ratio::ratio_type Ratio, class UnitValues, class System>
        class basic_unit;
        ...
        template<class Rep, collin::ratio::ratio_type Ratio, class UnitValues, class System, std::intmax_t Dimension = dynamic_dimension>
        ...
        template<class Rep, collin::ratio::ratio_type Ratio, class UnitValues, class System, std::intmax_t Dimension>
        ...
        template<class Rep, basic_dimension_unit_type... DimensionUnits>
...
namespace std
{
    template<class Rep1, collin::ratio::ratio_type Ratio1, class Rep2, collin::ratio::ratio_type Ratio2, class UnitValues, class System>
...
namespace collin
{
    namespace measures
    {
        template<basic_unit_type ToBasicUnit, class Rep, collin::ratio::ratio_type Ratio, class UnitValues, class System>
        ...
        template<class Rep1, collin::ratio::ratio_type Ratio, class UnitValues, class System, class Rep2>
        [[nodiscard]] constexpr
        ...
        template<class Rep1, collin::ratio::ratio_type Ratio1, class Rep2, class Ratio2, class UnitValues, class System>
        [[nodiscard]] constexpr
        typename std::common_type_t<basic_unit<Rep1, Ratio1, UnitValues, System>,
                                    basic_unit<Rep2, Ratio2, UnitValues, System>>
        operator%(const basic_unit<Rep1, Ratio1, UnitValues, System>& lhs, const basic_unit<Rep2, Ratio2, UnitValues, System>& rhs) noexcept
        ...
        template<collin::concepts::arithmetic Rep, collin::ratio::ratio_type Ratio, class UnitValues, class System, std::intmax_t Dimension>
            requires (Dimension != 0)
        class basic_dimension_unit
        {
            public:
                ...
                constexpr basic_dimension_unit(const basic_dimension_unit<Rep2, Ratio2, unit_values, system, Dimension2>& other, typename dimension_t::size_type d = 1)
                    : storage_{other.unit(), d}
                {
                    if constexpr(Dimension != Dimension2 || Dimension == dynamic_dimension)
                    {
                ...
                template<class Rep2, collin::ratio::ratio_type Ratio2, std::size_t Dimension2>
            ...
            private:
                ...
                [[nodiscard]] constexpr auto convert_dimension(const basic_dimension_unit<Rep2, Ratio2, unit_values, system, Dimension2>& other) noexcept(std::is_nothrow_copy_constructible_v<unit_t>)
                {
                    ...
                    if (correct_type.count() != 0)
                    {
                        ...
                        {
                            const auto powered_amount = static_cast<typename common_type::rep>(std::pow(correct_type.count(), static_cast<long double>(other.dimension()) / static_cast<long double>(dimension())));
                            return common_type{powered_amount};
                        }
                    }
        ...
        template<class Rep1, collin::ratio::ratio_type Ratio1, class Rep2, collin::ratio::ratio_type Ratio2, class UnitValues, class System, std::intmax_t Dimension1, std::intmax_t Dimension2>
        ...
        template<class Rep1, collin::ratio::ratio_type Ratio1, class Rep2, collin::ratio::ratio_type Ratio2, class UnitValues, class System, std::intmax_t Dimension>
        ...
        template<class Rep1, class Rep2, collin::ratio::ratio_type Ratio1, collin::ratio::ratio_type Ratio2, class UnitValues, class System, std::intmax_t Dimension1, std::intmax_t Dimension2>
        ...
        template<class Rep1, class Rep2, collin::ratio::ratio_type Ratio1, class UnitValues, class System, std::intmax_t Dimension>
        ...
        constexpr bool constant_dimensions = (... && !collin::concepts::same<typename DimensionUnits2::dimension_t, dimension_type<dynamic_dimension>>);
        ...
        class basic_derived_unit
        {
            ...
            template<basic_dimension_unit_type... DimensionUnits2>
            using result_ratio = collin::ratio::canonical_ratio<collin::ratio::multiply_many_t<
            ...
            template<basic_dimension_unit_type... DimensionUnits2>
            static constexpr bool same_dimensions = (... && collin::concepts::same<typename DimensionUnits::dimension_t, typename DimensionUnits2::dimension_t>);

            template<basic_dimension_unit_type... DimensionUnits2>
            static constexpr bool same_unit_values = (... && collin::concepts::same<typename DimensionUnits::unit_values, typename DimensionUnits2::unit_values>);

            template<basic_dimension_unit_type... DimensionUnits2>
            static constexpr bool same_systems = (... && collin::concepts::same<typename DimensionUnits::system, typename DimensionUnits2::system>);
            ...
            public:
                ...
                template<class Rep2, basic_dimension_unit_type... DimensionUnits2>
                    requires(constant_dimensions<DimensionUnits2...> && same_dimensions<DimensionUnits2...>)
                ...
                template<class Rep2, basic_dimension_unit_type... DimensionUnits2>
                    requires(constant_dimensions<DimensionUnits2...> && same_dimensions<DimensionUnits2...>)
                constexpr basic_derived_unit& operator=(const basic_derived_unit<Rep2, DimensionUnits2...>& other)
                {
                    amount_ = other.rational() * collin::math::rational_ratio<result_ratio<DimensionUnits2...>, Rep2>;
                    return *this;
                }
                ...
                template<class Rep2, basic_dimension_unit_type... DimensionUnits2>
                    requires(same_unit_values<DimensionUnits2...> && same_systems<DimensionUnits2...> && same_dimensions<DimensionUnits2...>)
                ...
                template<class Rep2, basic_dimension_unit_type... DimensionUnits2>
                    requires(same_unit_values<DimensionUnits2...> && same_systems<DimensionUnits2...> && same_dimensions<DimensionUnits2...>)
                [[nodiscard]] constexpr friend auto operator+(const basic_derived_unit& lhs, const basic_derived_unit<Rep2, DimensionUnits2...>& rhs) noexcept
                {
                    auto r {lhs};
                    r += rhs;
                    return r;
        ...
        template<class CharT, class Traits, class Rep, collin::ratio::ratio_type Ratio, class UnitValues, class System>
