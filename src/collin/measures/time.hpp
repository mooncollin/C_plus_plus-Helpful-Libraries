...
namespace collin
{
	namespace measures
	{
        ...
        template<class Rep, dimension_type Dimension = 1>
        using basic_minutes = time<Rep, metric_system, std::ratio_multiply<std::ratio<60>, typename basic_seconds<Rep>::ratio>, Dimension>;

        template<class Rep, dimension_type Dimension = 1>
        using basic_hours = time<Rep, metric_system, std::ratio_multiply<std::ratio<60>, typename basic_minutes<Rep>::ratio>, Dimension>;

        template<class Rep, dimension_type Dimension = 1>
        using basic_days = time<Rep, metric_system, std::ratio_multiply<std::ratio<24>, typename basic_hours<Rep>::ratio>, Dimension>;

        template<class Rep, dimension_type Dimension = 1>
        using basic_weeks = time<Rep, metric_system, std::ratio_multiply<std::ratio<7>, typename basic_days<Rep>::ratio>, Dimension>;
        ...
        template<class Rep, collin::ratio::ratio_type Ratio>
